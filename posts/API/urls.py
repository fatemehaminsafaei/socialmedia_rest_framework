...
from posts.API.views import PostListCreateAPIView, PostDetailAPIView, PinPostAPIView, CommentListCreateAPIView, \
    CommentRetrieveDestroyAPIView, RecentPostsAPIView, UserPostListAPIView
...
urlpatterns = [
    ...
    path('<uuid>/comments/', CommentListCreateAPIView.as_view(), name='comment_list_create'),
